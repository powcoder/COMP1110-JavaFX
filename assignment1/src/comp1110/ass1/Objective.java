...
public class Objective {
 ...
 public static Icon[][] iconPairsFromString(String pairEnconding) {
    Icon[][] icon =new Icon[pairEnconding.length()/2][2];
    for(int n=0;n<pairEnconding.length();n++) {
      switch (pairEnconding.charAt(n)) {
        case 'I':
          icon[n / 2][n % 2] = Icon.CAT;
          break;
        case 'Q':
          icon[n / 2][n % 2] = Icon.FROG;
          break;
        case 'R':
          icon[n / 2][n % 2] = Icon.WITCH;
          break;
        case 'S':
          icon[n / 2][n % 2] = Icon.BOOKS;
          break;
        case 'T':
          icon[n / 2][n % 2] = Icon.MUSHROOMS;
          break;
        case 'U':
          icon[n / 2][n % 2] = Icon.BROOM;
          break;
        case 'V':
          icon[n / 2][n % 2] = Icon.HAT;
          break;
        case 'W':
          icon[n / 2][n % 2] = Icon.PUMPKIN;
          break;
        case 'X':
          icon[n / 2][n % 2] = Icon.RAVEN;
          break;
        case 'Y':
          icon[n / 2][n % 2] = Icon.SKELETON;
          break;
        case 'Z':
          icon[n / 2][n % 2] = Icon.CAULDRON;
          break;
      }
    }
    return icon;
